...
OpenLayers.Control.DragFeature = OpenLayers.Class(OpenLayers.Control, {
     ...
     * pixel - {<OpenLayers.Pixel>} The pixel location of the mouse.
     * dx - {Float} The delta x value.
     * dy - {Float} The delta y value.
     */
    onDrag: function(feature, pixel, dx, dy) {},
    ...
    moveFeature: function(pixel) {
        ...
        var dx = res * (pixel.x - this.lastPixel.x);
        var dy = res * (this.lastPixel.y - pixel.y);
        this.feature.geometry.move(dx, dy);
        this.layer.drawFeature(this.feature);
        this.lastPixel = pixel;
        this.onDrag(this.feature, pixel, dx, dy);
    },
